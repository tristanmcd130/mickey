...
let assemble instructions: Object.t =
	...
	| ILodl a -> Buffer.add_uint16_be buffer (8 lsl 12 + a)
	| IStol a -> Buffer.add_uint16_be buffer (9 lsl 12 + a)
	| IAddl a -> Buffer.add_uint16_be buffer (10 lsl 12 + a)
	| ISubl a -> Buffer.add_uint16_be buffer (11 lsl 12 + a)
